return {
  ...
  opts = function(_, opts)
    ...
    opts.statusline = { -- statusline
      ...
      status.component.fill(),
      status.component.builder { -- wakastat: wired directly, our full opts.statusline rebuild
        -- below would otherwise wipe out the community recipe's table.insert
        provider = function()
          local ok, wakastat = pcall(require, "wakastat")
          return ok and (" " .. wakastat.status() .. " ") or ""
        end,
