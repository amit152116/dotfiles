...
function where {
    ...
    Get-Command $Pattern -ErrorAction SilentlyContinue |
        ForEach-Object {
            $_.Source -split ';' |
...
oh-my-posh init pwsh --config C:\Users\amit1\AppData\Local\Programs\oh-my-posh\themes\myTheme.omp.json | Invoke-Expression
